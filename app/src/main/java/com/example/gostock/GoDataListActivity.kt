...
class GoDataListActivity : AppCompatActivity() {
    ...
    private lateinit var goDataFileHandler: JsonFileHandler<StockEntry>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_go_data_list)
    ...
    private fun loadAndDisplayRecords() {
        ...
        val loadedEntries = goDataFileHandler.loadRecords()
