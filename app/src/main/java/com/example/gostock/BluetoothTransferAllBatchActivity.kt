...
class BluetoothTransferAllBatchActivity : AppCompatActivity() {
    ...
    private companion object {
        ...
        private const val APP_NAME = "GoStockBatchTransfer" // Unique name for this service
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bluetooth_transfer_all_batch)
        initUI()
        initBluetooth()
        setupClickListeners()
